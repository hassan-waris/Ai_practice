...
class MoveTurtleBot():
    ...
    def move_turtlebot(self, direction, moving_time, linear_speed=0.2):
...
if __name__ == '__main__':
    ...
    try:
        moveturtlebot_object.move_turtlebot("forward",5,0.2)
        moveturtlebot_object.move_turtlebot("backward",5,0.2)
